...
import { analystProviderLabel } from '@/lib/analyst-identity';
      ...
      <article className="max-w-3xl px-6 py-12 space-y-10 xl:px-0">
        ...
        <header>
          <div className="flex items-baseline justify-between gap-4 flex-wrap mb-4">
            <div className="meta report-muted">
          ...
          <h1 className="display-hard-sm text-3xl text-fg">
            {v.meta.label}
          </h1>
        ...
        <section className="report-card bg-bg-elev border border-border-1 rounded-md p-8">
          <div className="meta text-accent report-accent mb-3">
            Verdict
          </div>
        ...
        {(v as any).commentary && (
          <section>
            ...
            <div className="report-card bg-bg-elev border border-border-1 rounded-md p-6">
              ...
              {/* The raw provider string is written by the API and carries the
                  gateway's own name inside it. This is the PUBLIC report, the
                  surface most likely to be screenshotted and posted, so it is
                  the last place that may name a third party.
                  `analystProviderLabel` keeps the one distinction a reader
                  needs, model or deterministic floor, in Omi's own words. */}
              <div className="meta report-muted mt-3">
                Generated by {analystProviderLabel((v as any).commentary.provider)}
