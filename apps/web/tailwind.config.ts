...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow':       '0 0 22px rgba(59,142,255,0.2), 0 0 44px rgba(59,142,255,0.07)',
        'glow-sm':    '0 0 10px rgba(59,142,255,0.32)',
        'glow-lg':    '0 0 44px rgba(59,142,255,0.26), 0 0 88px rgba(139,92,246,0.1)',
        'glow-violet':'0 0 26px rgba(139,92,246,0.28)',
        'glow-danger':'0 0 22px rgba(251,59,107,0.24)',
        'card':       '0 6px 28px rgba(0,0,0,0.45)',
        'card-lg':    '0 12px 56px rgba(0,0,0,0.6), 0 2px 10px rgba(0,0,0,0.45)',
        'inner-top':  'inset 0 1px 0 rgba(255,255,255,0.05)',
      },
      backgroundImage: {
        'accent-gradient': 'linear-gradient(135deg, #6ba9ff 0%, #3b8eff 48%, #8b5cf6 120%)',
        'accent-radial':   'radial-gradient(circle at center, rgba(59,142,255,0.15), transparent 70%)',
      ...
      keyframes: {
        ...
        'glow-pulse': {
          '0%, 100%': { boxShadow: '0 0 8px rgba(59,142,255,0.14)' },
          '50%':       { boxShadow: '0 0 30px rgba(59,142,255,0.42)' },
        },
        'border-flow': {
