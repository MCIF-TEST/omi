...
_SCORE_DISCIPLINE = ConstitutionBlock(
    ...
    "innocently. 75-100: see the mechanical gate below. Independence is the load-bearing word: three "
    "restatements of one observation are ONE indicator, not three.\n"
    ...
    "accident. At least ONE of these must be present AND written into the assessment as a quote or a "
    "figure:\n"
    ...
    "  ZERO POSTS COLLECTED: score 10 to 20 and confidence 20 or less, always, whatever the follower "
    "counts look like. Nothing about this account's behaviour was observed, so there is nothing to "
    "score. Say exactly that in the assessment and stop. Two accounts with no history must not come "
    "out 30 points apart.\n"
    ...
    "- CHECK THE DISTRIBUTION BEFORE YOU EMIT. When every account has been scored, count how many "
    "landed at 50 or above. A real comment section usually comes out with most accounts low and a "
    "handful of genuine outliers, so expect roughly one in ten, not four. If more than a QUARTER of "
