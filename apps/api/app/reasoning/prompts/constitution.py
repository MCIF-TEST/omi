...
_SCORE_DISCIPLINE = ConstitutionBlock(
    ...
    "  (b) posting intervals regular enough that a scheduler explains them better than a person. "
    "State the interval you observed, for example 'a post almost exactly every hour'.\n"
    ...
    "captured section, and it is the failure that gets real people accused.\n"
...
_OUTPUT_FORMATTING = ConstitutionBlock(
    ...
    "history / activity_sample_count 0'. An alias such as A13 never appears in a per-account "
    "'assessment': the reader has never seen those labels, and a served paragraph containing one is "
    "withheld. Aliases belong in 'ref' and 'citations'. Never leave a bare metric or code token as "
    "the explanation.\n"
