...
def _render_output_contract(schema: dict) -> str:
    ...
    if COMPREHENSIVE_COMMENTER_ASSESSMENTS_KEY in props:
        commenter_clause = (
            ...
            f"75-100 high); a CONCISE 'assessment' (1-3 sentences grounded in THAT account's specific "
            f"evidence — never a boilerplate sentence repeated across accounts); and a 'citations' array. "
