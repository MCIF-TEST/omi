...
def render_markdown(
    *,
    ...
    add("---")
    add("")
    add("> **These scores are probabilistic readings of public behaviour, not findings of fact.**")
    add("> They describe how closely an account's public activity resembles patterns associated")
    add("> with bought or automated engagement.")
    add(">")
    add("> They are not an allegation that any person has broken a law or a platform rule.")
    add("> They make no claim about who operates an account, whether money changed hands,")
    add("> or anyone's intent.")
    add(">")
    add("> Automated analysis is wrong sometimes, in both directions: businesses, fan accounts,")
    add("> news feeds, new users, and people writing in a second language can all resemble")
    add("> these patterns.")
    add(">")
    add("> Published for transparency about engagement, and meant to be checked rather than")
    add("> taken on trust.")
    add(">")
    add("> Named in this report and think it is wrong? Open the report link and use")
    add("> \"Request a review\". No account is needed, and reports that cannot be stood up are removed.")
    add("")
    add("---")
    add("")
    add("## Verdict")
    ...
    add("")
    add(
        "_All output is probabilistic and evidence-bearing, never a definitive judgement about the "
        "account or the person behind it. Scope and limits: /accuracy_"
    )
    return "\n".join(lines)
