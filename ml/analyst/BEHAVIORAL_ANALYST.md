...
> GENERATED from `app.reasoning.prompts.behavioral` (library v1, constitution v5). Do not hand-edit; regenerate via `python -m app.reasoning.prompts.export`. This is the REFERENCE IMPLEMENTATION every future specialist library follows.
...
## 7. Prompt versions
- live `v1` (active, unchanged) · library `lib-v1` (inert) · **`lib-v2`** (inert, this library's improvement) `ph:596b95393ad9afe1863c067f16e3bbe8`
