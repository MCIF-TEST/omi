...
> GENERATED from `app.reasoning.prompts.framework` (framework v1, `sf:4e5a032d865a1d3055fab58ae3b65dde`, constitution v5). Do not hand-edit; regenerate via `python -m app.reasoning.prompts.export`.
...
- **Prompt:** lib-v1 `ph:c019fa395e75ec20f908fc5909b3f542`
...
- **Prompt:** lib-v1 `ph:4723df52ee32784ce10378c0701d9ac5`
...
- **Authority:** challenge, calibrate, and advise; may lower or bound a read, never raise the number
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:57da795c588b6f7207c037004ef2ee3c`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:ec0ec7db5f843cdbe5fb5ff768c09588`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Prompt:** lib-v1 `ph:7ed414e62c69628b18e16bd640de2bdd`
- **Schema:** council critique artifact contract · **Token budget:** 1024
...
- **Prompt:** lib-v1 `ph:5356b779cb07569075f2943eedfbe85f`
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:9da119eb19f9192b578f2d48e411a053`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Prompt:** lib-v1 `ph:5fd4c38de13e4aca890995f40c286519`
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:f80ad8535f3a21016c3c022fcad4db0b`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:36899e24205985001b386d4a3c8f5ad0`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:b2fb3a430ebefac0e06df30d2b73fbe4`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Prompt:** lib-v1 `ph:a53e07491258cb44b40bc794c1a80709`
- **Schema:** council critique artifact contract · **Token budget:** 1024
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:1bea2f4913b43069673b77a91b7832a9`
- **Schema:** council finding artifact contract · **Token budget:** 1024
