...
> GENERATED from `app.reasoning.prompts.framework` (framework v1, `sf:1ae2d0580e82e0de54699c92b3f65726`, constitution v10). Do not hand-edit; regenerate via `python -m app.reasoning.prompts.export`.
...
- **Prompt:** lib-v1 `ph:88790643b49d597e7c0b85109edac994`
...
- **Prompt:** lib-v1 `ph:8fceb6f6c06a9bbee8ec9b3a743fce36`
...
- **Authority:** challenge, calibrate, and advise; may lower or bound a read, never raise the number
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:18f634663171b63d7d0214145f74ab22`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:541eedfd106fd476b60a2641bb771e81`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Prompt:** lib-v1 `ph:c52187eed58d4073badd4b23dcab35b8`
- **Schema:** council critique artifact contract · **Token budget:** 1024
...
- **Prompt:** lib-v1 `ph:e69e64ef7790c56c675a9fec90854dfe`
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:598e474ae9e59cfac0eba4348ad69fd2`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Prompt:** lib-v1 `ph:d1ed7b51020c07a0c581531fc043bc9e`
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:d6cf41de88a5910dad8ed20d4e4676cd`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:736a223647814ac1bc2fb53019a7944e`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:4f985c31363ce79ab2df2abcf239ab9c`
- **Schema:** council finding artifact contract · **Token budget:** 1024
...
- **Prompt:** lib-v1 `ph:b9c0e82ed550e86299d3c475bf920d6b`
- **Schema:** council critique artifact contract · **Token budget:** 1024
...
- **Authority:** interpret evidence into cited artifacts; no verdicts, no score movement
- **Output:** One JSON object: {"findings":[{"signal":"<name>","claim":"<probabilistic sentence>","direction":"raises|lowers|neutral","evidence_refs":["ev:..."]}],"uncertaint
- **Prompt:** lib-v1 `ph:9612778b374f05f2889127a7861ab184`
- **Schema:** council finding artifact contract · **Token budget:** 1024
